...
public class Alarm implements Comparable<Alarm> {
    ...
    public String toJson() {
        ...
        try {
            ...
            jsonObject.put("isStartSchedule", isStartSchedule);
    ...
    public static Alarm fromJson(String string) {
        ...
        try {
            ...
            alarm.isStartSchedule = jsonObject.getBoolean("isStartSchedule");
        } catch (JSONException e) {
    ...
    public boolean equals(Object o) {
        ...
        return id == alarm.id &&
                ...
                hour == alarm.hour &&
                minute == alarm.minute &&
                isStartSchedule == alarm.isStartSchedule;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, month, date, hour, minute, isStartSchedule);
    }
