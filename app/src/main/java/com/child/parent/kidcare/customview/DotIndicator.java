...
public class DotIndicator extends LinearLayout {
    ...
    private void initCircle(){
        ...
        selectedDrawable.setIntrinsicHeight(30);
        selectedDrawable.setIntrinsicWidth(30);
        ...
        unSelectedDrawable.setIntrinsicHeight(20);
        unSelectedDrawable.setIntrinsicWidth(20);
